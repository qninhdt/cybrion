...
#include "world/block/nature/cactus_block.hpp"
...
namespace cybrion
{
    ...
    public:
        ...
        static MineralBlock &COPPER;
        static MineralBlock &IRON;
        static MineralBlock &LAPIS;
        static MineralBlock &EMERALD;
        static MineralBlock &GOLD;
        static MineralBlock &DIAMOND;
