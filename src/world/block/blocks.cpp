...
namespace cybrion
{
    ...
    MineralBlock &Blocks::COPPER = MINERAL.set<"type">(MineralType::COPPER);
    MineralBlock &Blocks::IRON = MINERAL.set<"type">(MineralType::IRON);
    MineralBlock &Blocks::LAPIS = MINERAL.set<"type">(MineralType::LAPIS);
    MineralBlock &Blocks::EMERALD = MINERAL.set<"type">(MineralType::EMERALD);
    MineralBlock &Blocks::GOLD = MINERAL.set<"type">(MineralType::GOLD);
    MineralBlock &Blocks::DIAMOND = MINERAL.set<"type">(MineralType::DIAMOND);
